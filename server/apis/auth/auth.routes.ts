...
router.post('/check-email', validateBody(checkEmailDto), authController.checkEmailAvailability);
router.post('/check-workspace', validateBody(checkWorkspaceDto), authController.checkWorkspaceAvailability);
